...
import { ProductsContext, FirebaseContext } from '@/store/Context'
import React, { useState, useContext, useEffect } from 'react'
import { Button } from "./ui/button";



function EditCategory({ closeModal, categoryId, categoryName }) {
    ...
    const handleSubmit = (e) => {
        ...
        firebase.firestore().collection('product_categories').doc(categoryId).update({
            category: category
        }).then(() => {
                        ...
                        <div className="sm:flex sm:items-start">
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <form>
                                    ...
                                    <Button onClick={handleSubmit} variant="outline" className="red" type="submit">Update</Button>
                                </form>
                            </div>
                        </div>
                    </div>
